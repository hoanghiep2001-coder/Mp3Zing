    ...
    PlaylistSong: {
      1: [
        ...
        },
        {
          ...
          duration: "04:21",
          source:
            "../Content/music/MyPlaylist/BecauseImStupid-SS501-205763.mp3",
          dataPlaylist: 1,
        },
        {
      ...
      2: [
        ...
        },
        {
          ...
          duration: "05:00",
          source: "../Content/music/TopHitsVPop/BadBoy-DongNhi-3599515.mp3",
          dataPlaylist: 2,
        },
        {
          image: "../Content/image/Artist/MyPlaylist/baotienmotmobinhyen.jpg",
        ...
        },
        {
          ...
          duration: "04:01",
          source: "../Content/music/TopHitsVPop/BuaYeu-BichPhuong-5472208.mp3",
          dataPlaylist: 2,
        },
        {
          image: "../Content/image/Artist/MyPlaylist/sontung.jpg",
        ...
        {
          image:
            "../Content/image/Playlist/PersonalPlaylist/deminoichomanghe.png",
      ...
      3: [
        ...
        },
        {
          ...
          duration: "04:21",
          source: "../Content/music/Top100VPop/thethai.mp3",
          dataPlaylist: 3,
        },
        {
          image:
            "../Content/image/Playlist/PersonalPlaylist/trentinhbanduoitinhyeu.jpg",
          name: "Trên Tình Bạn Dưới Tình Yêu",
          author: "MIN",
          album: "Trên Tình Bạn Dưới Tình Yêu (Official)",
          duration: "04:21",
          source: "../Content/music/Top100VPop/trentinhbanduoitinhyeu.mp3",
          dataPlaylist: 3,
        },
        {
          image:
            "../Content/image/Playlist/PersonalPlaylist/loyeunguoidamsau.jpg",
          name: "Lỡ Yêu Người Đậm Sâu - Remix",
          author: "",
          album: "",
          duration: "04:21",
          source: "../Content/music/Top100VPop/loyeunguoidamsau.mp3",
          dataPlaylist: 3,
        },
      ],
      4: [
        {
          image:
            "../Content/image/Playlist/PersonalPlaylist/cheating on you.jpg",
          name: "Cheating On You",
          author: "Charlie Puth",
          album: "Cheating On You (Official)",
          duration: "03:16",
          source: "../Content/music/TopUsUK/CheatingOnYou.mp3",
          dataPlaylist: 4,
        },
        {
          ...
          album: "Finals 2020",
          duration: "02:39",
          source: "../Content/music/TopUsUK/LolTheme.mp3",
          dataPlaylist: 4,
        },
        {
          ...
          duration: "03:31",
          source: "../Content/music/TopUsUK/River.mp3",
          dataPlaylist: 4,
        },
        {
          ...
          duration: "03:10",
          source: "../Content/music/TopUsUK/Senorita.mp3",
          dataPlaylist: 4,
        },
        {
          ...
          duration: "03:28",
          source: "../Content/music/TopUsUK/WayBack.mp3",
          dataPlaylist: 4,
        },
        {
          ...
          album: "",
          duration: "03:48",
          source: "../Content/music/TopUsUK/Monsters.mp3",
          dataPlaylist: 4,
        },
        {
          ...
          album: "",
          duration: "03:16",
          source: "../Content/music/TopUsUK/Hero.mp3",
          dataPlaylist: 4,
        },
      ],
      5: [
        {
          ...
          duration: "03:16",
          source: "../Content/music/TopKpop/lovescenario.mp3",
          dataPlaylist: 5,
        },
        {
          ...
          album: "I MADE",
          duration: "03:16",
          source: "../Content/music/TopKpop/senorita.mp3",
          dataPlaylist: 5,
        },
      ],
      6: [
        {
          image:
            "../Content/image/Playlist/PersonalPlaylist/SonTungMTP/amThamBenEm.jpg",
          name: "Âm Thầm Bên Em",
          author: "Sơn Tùng - MTP",
          album: "Âm Thầm Bên Em (Single)",
          duration: "04:51",
          source: "../Content/music/SonTungMTP/amThamBenEm.mp3",
          dataPlaylist: 6,
        },
        {
          image:
            "../Content/image/Playlist/PersonalPlaylist/SonTungMTP/Buongdoitaynhauramtp.jpg",
          name: "Buông Đôi Tay Nhau Ra",
          author: "Sơn Tùng - MTP",
          album: "",
          duration: "03:46",
          source:
            "../Content/music/SonTungMTP/BuongDoiTayNhauRa-SonTungMTP-4184408.mp3",
          dataPlaylist: 6,
        },
        {
          image:
            "../Content/image/Playlist/PersonalPlaylist/SonTungMTP/chayNgayDi.png",
          name: "Chạy Ngay Đi",
          author: "Sơn Tùng - MTP",
          album: "Chạy Ngay Đi (Single)",
          duration: "04:51",
          source: "../Content/music/SonTungMTP/chayngaydi.mp3",
          dataPlaylist: 6,
        },
        {
          image:
            "../Content/image/Playlist/PersonalPlaylist/SonTungMTP/chungTaKhongThuocVeNhau.jpg",
          name: "Chúng Ta Không Thuộc Về Nhau",
          author: "Sơn Tùng - MTP",
          album: "Chúng Ta Không Thuộc Về Nhau (Single)",
          duration: "04:51",
          source: "../Content/music/SonTungMTP/chungTaKhongThuocVeNhau.mp3",
          dataPlaylist: 6,
        },
        {
          image:
            "../Content/image/Playlist/PersonalPlaylist/SonTungMTP/emCuaNgayHomQua.png",
          name: "Em Của Ngày Hôm Qua",
          author: "Sơn Tùng - MTP",
          album: "Em Của Ngày Hôm Qua (Single)",
          duration: "04:51",
          source: "../Content/music/SonTungMTP/emCuaNgayHomQua.mp3",
          dataPlaylist: 6,
        },
        {
          image:
            "../Content/image/Playlist/PersonalPlaylist/SonTungMTP/hayTraoChoAnh.jpg",
          name: "Hãy Trao Cho Anh",
          author: "Sơn Tùng - MTP",
          album: "Hãy Trao Cho Anh (Single)",
          duration: "04:51",
          source: "../Content/music/SonTungMTP/hayTraoChoAnh.mp3",
          dataPlaylist: 6,
        },
        {
          image:
            "../Content/image/Playlist/PersonalPlaylist/SonTungMTP/lacTroiRemix.jpg",
          name: "Lạc Trôi - TripleD Remix",
          author: "Sơn Tùng - MTP",
          album: "",
          duration: "04:51",
          source: "../Content/music/SonTungMTP/lacTroiTripleDRemix.mp3",
          dataPlaylist: 6,
        },
        {
          image:
            "../Content/image/Playlist/PersonalPlaylist/SonTungMTP/nhuNgayHomQua.jpg",
          name: "Như Ngày Hôm Qua",
          author: "Sơn Tùng - MTP",
          album: "Chàng Trai Năm Ấy (OST)",
          duration: "04:51",
          source: "../Content/music/SonTungMTP/nhungayhomqua.mp3",
          dataPlaylist: 6,
        },
      ],
      7: [],
      8: [
        {
          ...
          album: "LCK",
          duration: "11:30",
          source: "../Content/music/LoLMix/2022lckHightlightBgm.mp3",
          dataPlaylist: 8,
        },
        {
          image: "../Content/image/Playlist/PersonalPlaylist/lck2022bgm.jpg",
          ...
          album: "LCK",
          duration: "04:43",
          source: "../Content/music/LoLMix/2022lckVictoryBgm.mp3",
          dataPlaylist: 8,
        },
        {
          ...
          duration: "03:31",
          source: "../Content/music/LoLMix/burnitalldown.mp3",
          dataPlaylist: 8,
        },
        {
          image: "../Content/image/Playlist/PersonalPlaylist/loltheme2020.jpg",
          ...
          duration: "02:40",
          source: "../Content/music/LoLMix/LolTheme.mp3",
          dataPlaylist: 8,
        },
        {
          image: "../Content/image/Artist/MyPlaylist/more.jpg",
          ...
          album: "K/DA ALL OUT",
          duration: "03:36",
          source: "../Content/music/LoLMix/more.mp3",
          dataPlaylist: 8,
        },
        {
          ...
          album: "ARCANE",
          duration: "02:57",
          source: "../Content/music/LoLMix/dynasties.mp3",
          dataPlaylist: 8,
        },
        {
          ...
          album: "ARCANE",
          duration: "03:33",
          source: "../Content/music/LoLMix/enemy.mp3",
          dataPlaylist: 8,
        },
        {
          image:
            "../Content/image/Playlist/PersonalPlaylist/legendneverdie.jpg",
          name: "Legends Never Die",
          author: "League Of Legends",
          album: "2016 Worlds Champion Ship",
          duration: "02:58",
          source: "../Content/music/LoLMix/legendneverdie.mp3",
          dataPlaylist: 8,
        },
        {
          ...
          album: "ARCANE",
          duration: "03:50",
          source: "../Content/music/LoLMix/playground.mp3",
          dataPlaylist: 8,
        },
        {
          ...
          duration: "03:16",
          source: "../Content/music/LoLMix/rise.mp3",
          dataPlaylist: 8,
        },
        {
          ...
          album: "K/DA ALL OUT",
          duration: "02:55",
          source: "../Content/music/LoLMix/thebaddest.mp3",
          dataPlaylist: 8,
        },
      ],
    },
    ...
    ExploreSuggestList: [
      {
        ...
        name: "2010s Ballad",
        author:
          "Sam Smith, Adele, Calum Scott, Taylor Swift, Alan Walker, Justin Bieber",
      },
      {
      ...
      Monday: [
        {
          ...
          author:
            "Thứ 2 là phải nhảy theo những track Remix thịnh hành nhất hiện nay",
        },
        {
          name: "K-Pop Dance",
          image:
            "../Content/image/Playlist/Explore/MusicForDays/kpopdance.webp",
          author:
            "Đốt cháy năng lượng bằng những vũ đạo đỉnh nhất thế giới hiện tại",
        },
        {
          name: "Nhà Nhà Nghe Gì",
          image:
            "../Content/image/Playlist/Explore/MusicForDays/onhanghegi.webp",
...

        {
          ...
          image:
            "../Content/image/Playlist/Explore/MusicForDays/lacluchohetbuon.webp",
          author:
            "Lắc lự quên hết mọi buồn phiền với những giai điệu hay nhất hiện nay",
        },
      ],
      Tuesday: [
        {
          ...
          author:
            "Thứ 3 là phải nhảy theo những track Remix thịnh hành nhất hiện nay",
        },
        {
          name: "K-Pop Dance",
          image:
      ...
      Saturday: [
        {
          ...
          author:
            "Thứ 7 là phải nhảy theo những track Remix thịnh hành nhất hiện nay",
        },
        {
          name: "K-Pop Dance",
          image:
